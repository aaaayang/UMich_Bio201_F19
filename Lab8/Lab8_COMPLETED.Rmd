...
#The low-p values mean that the clustering of samples by semester and study week is statistically significant. Based upon the R^2 and low R value, there is also a weak correlation between the study week/semester and the species data. Therefore, the results can be attributed to variance within the sample. 
```
